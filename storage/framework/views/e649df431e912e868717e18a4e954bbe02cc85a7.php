...
<?php if($objAdmin->is_super == 1 || $objAdmin->position_id == 3|| $objAdmin->position_id == 4): ?>
    <!--begin::Post-->
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
                ...
                <div class="row g-5 g-xl-8">
                    <div class="col-xl-4">
                        <a href="<?php echo e(route('admin.courses.index')); ?>" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                            <div class="card-body">
                                <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5"><?php echo e($count_courses); ?></div>
                                <div class="fw-bold text-gray-400">الكورسات</div>
                            </div>
                        </a>
                    </div>
                    <div class="col-xl-4">
                        <a href="<?php echo e(route('admin.payments.index')); ?>" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                            <div class="card-body">
                                <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5"><?php echo e($count_pending_payments); ?></div>
                    ...
                    <div class="col-xl-4">
                        <div class="card bg-body hoverable card-xl-stretch mb-xl-8">
                            <div class="card-body">
                                <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5"><?php echo e($count_approved_users); ?></div>
                                <div class="fw-bold text-gray-400">مشتركين معتمدين</div>
                            </div>
                        </div>
                    </div>
                    <?php if($objAdmin->is_super == 1 || $objAdmin->position_id == 2): ?>
                    <div class="col">
                        <!--begin::Statistics Widget 5-->
                        <a href="<?php echo e(url('/admin/leaders')); ?>" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                                <!--begin::Body-->
                                <div class="card-body">
                                    ...
                                    <!--end::Svg Icon-->
                                    <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5"><?php echo e($count_users); ?></div>
                                    <div class="fw-bold text-gray-400"><?php echo e(__('messages.users')); ?></div>
                                </div>
                                <!--end::Body-->
                            </a>
...
<?php echo $__env->make('auth.admin.include.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\courses\resources\views/auth/admin/dashboard.blade.php ENDPATH**/ ?>