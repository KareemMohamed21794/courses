    ...
    <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
        ...
        <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
            <div class="menu-item me-lg-1">
                    ...
                    <span style="color: #009EF7;" class="menu-title"><?php echo e(__('messages.welcome')); ?> 
            ...
            <div  class="d-none d-flex align-items-center ms-1 ms-lg-3">
                ...
                <div class="btn btn-icon btn-active-light-primary position-relative w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                    ...
                    <!--end::Svg Icon-->
                    <span class="badge badge-danger position-absolute top-0 start-100 translate-middle badge-circle" style="transform: translate(-50%, -50%);"><?php echo e(count($notifications)); ?></span>
                </div>
                <!--begin::Menu-->
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="kt_topbar_notifications_1" role="tabpanel">
                            ...
                            <div class="scroll-y mh-325px my-5 px-8">
                                    ...
                                    <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="d-flex flex-stack py-4">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <!--begin::Title-->
                                                <div class="mb-0 me-2">
                                                    <a target="_blank" href="<?php echo e(url('admin/advertisements')); ?>" class="fs-6 text-gray-800 text-hover-primary fw-bolder"><?php echo e($notification['title']); ?></a>
                                                    <div class="text-gray-400 fs-7"><?php echo e($notification['body']); ?></div>
                                                </div>
                                                <!--end::Title-->
                                            </div>
                                            <!--end::Section-->
                                ...
                                <?php else: ?>
                                <h1><?php echo e(__('messages.no_notifications')); ?></h1>
                                <?php endif; ?>
...
</style><?php /**PATH E:\xampp\htdocs\courses\resources\views/auth/admin/include/navbar.blade.php ENDPATH**/ ?>