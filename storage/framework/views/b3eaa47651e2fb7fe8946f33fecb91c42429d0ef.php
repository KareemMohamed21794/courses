    ...
    <div class="d-flex align-items-stretch flex-shrink-0">
        ...
        <div class="d-none d-flex align-items-center ms-1 ms-lg-3">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                <!--begin::Heading-->
                <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url(<?php echo e(asset('demo1/dist/assets/media/misc/pattern-1.jpg')); ?>)"  >
                    <!--begin::Title-->
                    <h3 class="text-white fw-bold px-9 mt-10 mb-6"><?php echo e(__('messages.Notifications')); ?>
                        ...
                        <div class="scroll-y mh-325px my-5 px-8">
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--begin::Title-->
                                    <div class="mb-0 me-2">
                                        <a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bolder"></a>
        ...
        <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
            ...
            <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                <img src="<?php echo e(asset('public/images/profile.jpg')); ?>" alt="user" />
            </div>
            <!--begin::Menu-->
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                ...
                <div class="menu-item px-3">
                    <div class="menu-content d-flex align-items-center px-3">
                        ...
                        <div class="symbol symbol-50px me-5">
                            <img alt="Logo" src="<?php echo e(asset('public/images/profile.jpg')); ?>" />
                        </div>
                        <!--end::Avatar-->
                        <!--begin::Username-->
                        <div class="d-flex flex-column">
                            <div class="fw-bolder d-flex align-items-center fs-5"><?php echo e(__('messages.welcome')); ?> 

                                <?php if($objAdmin->is_super == 1 || $objAdmin->position_id == 3|| $objAdmin->position_id == 4|| $objAdmin->position_id == 5|| $objAdmin->position_id == 6): ?>
                                <?php echo e($objAdmin->name); ?>

                                <?php else: ?>
                                <?php echo e($objAdmin->group_name); ?>
                ...
                <div style="display:none;" class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
                    <?php if(empty(session('admin_locale')) ||  session('admin_locale')=='en'): ?>
                    <a href="#" class="menu-link px-5">
                        <span class="menu-title position-relative"><?php echo e(__('messages.Language')); ?>

                        <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0"><?php echo e(__('messages.English')); ?>

                        <img class="w-15px h-15px rounded-1 ms-2" src="<?php echo e(asset('demo1/dist/assets/media/flags/united-states.svg')); ?>" alt="" /></span></span>
                    </a>
                    <?php elseif(session('admin_locale')=='ar'): ?>
                    <a href="#" class="menu-link px-5">
                        <span class="menu-title position-relative"><?php echo e(__('messages.Language')); ?>

                        <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0"><?php echo e(__('messages.Arabic')); ?>

                        <img class="w-15px h-15px rounded-1 ms-2" src="<?php echo e(asset('demo1/dist/assets/media/flags/egypt.svg')); ?>" alt="" /></span></span>
                    </a>
                    <?php endif; ?>
                    <!--begin::Menu sub-->
                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                        ...
                        <div class="menu-item px-3">
                            <?php if(Request::segment(1)=='admin'): ?>
                                <a href="<?php echo e(route('admin_language','en')); ?>" class="menu-link d-flex px-5 active">
                            <?php else: ?>
                                <a href="<?php echo e(route('client_language','en')); ?>" class="menu-link d-flex px-5 active">
                            <?php endif; ?>
                            
                            <span class="symbol symbol-20px me-4">
                                <img class="rounded-1" src="<?php echo e(asset('demo1/dist/assets/media/flags/united-states.svg')); ?>" alt="" />
                            </span><?php echo e(__('messages.English')); ?></a>
                        </div>
                        <!--end::Menu item-->
                        ...
                        <div class="menu-item px-3">
                            <?php if(Request::segment(1)=='admin'): ?>
                                <a href="<?php echo e(route('admin_language','ar')); ?>" class="menu-link d-flex px-5 active">
                            <?php else: ?>
                                <a href="<?php echo e(route('client_language','ar')); ?>" class="menu-link d-flex px-5 active">
                            <?php endif; ?>
                            
                            <span class="symbol symbol-20px me-4">
                                <img class="rounded-1" src="<?php echo e(asset('demo1/dist/assets/media/flags/egypt.svg')); ?>" alt="" />
                            </span><?php echo e(__('messages.Arabic')); ?></a>
                        </div>
                        <!--end::Menu item-->
                ...
                <!--end::Menu item-->
                <!--begin::Menu item-->
                <div style="display:none;" class="menu-item px-5 my-1">
                    <a href="<?php echo e(url('/client/profile')); ?>" class="menu-link px-5"><?php echo e(__('messages.Account Settings')); ?></a>
                </div>
                <!--end::Menu item-->
                <!--begin::Menu item-->
                <div class="menu-item px-5">
                    ...
                    <form method="POST" action="<?php echo e(route('admin_logout')); ?>">
                        <?php echo csrf_field(); ?>
                        <a class="menu-link px-5" href="<?php echo e(route('admin_logout')); ?>" onclick="event.preventDefault();this.closest('form').submit();"><?php echo e(__('messages.Sign Out')); ?></a>
                    </form>
                    <?php else: ?>
                    <form method="POST" action="<?php echo e(route('client_logout')); ?>">
                        <?php echo csrf_field(); ?>
                        <a class="menu-link px-5" href="<?php echo e(route('client_logout')); ?>" onclick="event.preventDefault();this.closest('form').submit();"><?php echo e(__('messages.Sign Out')); ?></a>
                    </form>
                ...
                <div class="menu-item px-5" style="display: none;">
                    <div class="menu-content px-5">
                        <label class="form-check form-switch form-check-custom form-check-solid pulse pulse-success" for="kt_user_menu_dark_mode_toggle">
                            <?php if(Request::segment(1)=='admin'): ?>
                            <input class="form-check-input w-30px h-20px" type="checkbox" <?php echo e(session('darkmode') ? 'checked' : ''); ?> value="1" name="mode" id="kt_user_menu_dark_mode_toggle" data-kt-url="<?php echo e(route('admin_darkmode')); ?>" />
                            <?php elseif(Request::segment(1)=='client'): ?>
                            <input class="form-check-input w-30px h-20px" type="checkbox" <?php echo e(session('darkmode') ? 'checked' : ''); ?> value="1" name="mode" id="kt_user_menu_dark_mode_toggle" data-kt-url="<?php echo e(route('client_darkmode')); ?>" />
                            <?php endif; ?>
...
<!--end::Topbar--><?php /**PATH E:\xampp\htdocs\courses\resources\views/auth/admin/include/topbar.blade.php ENDPATH**/ ?>