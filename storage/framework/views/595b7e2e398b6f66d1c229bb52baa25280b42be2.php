                ...
                <div class="d-flex flex-column align-items-start">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <div class="symbol symbol-35px symbol-circle">
                            <img alt="Pic" src="<?php echo e(asset('demo1/dist/assets/media/avatars/150-15.jpg')); ?>" />
                        </div>
                        <!--end::Avatar-->
                        <!--begin::Details-->
                        <div class="ms-3">
            ...
            <div class="d-flex justify-content-end mb-10">
                ...
                <div class="d-flex flex-column align-items-end">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <!--begin::Avatar-->
                        <div class="symbol symbol-35px symbol-circle">
                            <img alt="Pic" src="<?php echo e(asset('demo1/dist/assets/media/avatars/150-26.jpg')); ?>" />
                        </div>
                        <!--end::Avatar-->
                    </div>
                    <!--end::User-->
...
<!--end::Chat drawer--><?php /**PATH E:\xampp\htdocs\courses\resources\views/auth/admin/include/chat_drawer.blade.php ENDPATH**/ ?>