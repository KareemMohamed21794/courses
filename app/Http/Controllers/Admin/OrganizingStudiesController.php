...
class OrganizingStudiesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('auth.admin.organizing_study.index',['title' => $title, 'add_title' => $add_title,'leaders'=>$leaders,'can_add'=>$can_add, 'can_update'=>$can_update, 'can_delete'=>$can_delete, 'can_print'=>$can_print,'objAdmin'=>$objAdmin]);
