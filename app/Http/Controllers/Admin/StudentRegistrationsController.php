...
class StudentRegistrationsController extends Controller
{
    ...
    { 
        ...
        $active = $request->active;
           ...
           $alldata = StudentRegistration::where('type',$type)->get();
        
            if($active=='All'){
                $alldata = StudentRegistration::withTrashed()->where('type',$type)->get();
            }
            elseif($active=='Active'){
                $alldata = StudentRegistration::get();
            }
            elseif($active=='DeActive'){
                $alldata = StudentRegistration::onlyTrashed()->where('type',$type)->get();
            }
        ...
        foreach($alldata as $key=> $objdata){
            ...
            $alldataResult[] = array(
                ...
                "id" => $objdata->id,
                "description_ar" => $objdata->description_ar,
                "description_en"=> $objdata->description_en,
