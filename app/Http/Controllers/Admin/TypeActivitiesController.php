...
{
    private const MODEL ='TypeActivity';
    /**
    ...
    {
        $title = __('messages.type_activity');
        $add_title = __('messages.type_activity');
        $userId = Auth::id();
        $objAdmin = Admin::find($userId);

        return view('auth.admin.type_activity.index',['title' => $title, 'add_title' => $add_title,'objAdmin'=>$objAdmin]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $TypeActivity = TypeActivity::create([
    ...
    public function edit($id)
    {
        ...
        return response()->json($TypeActivity);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $objTypeActivity = TypeActivity::find($id);
       
        $objTypeActivity->name_ar =  $request->name_ar;
    ...
    public function destroy($id)
    {
     ...
     public function deleteTypeActivity(Request $request)
    {
        //$this->authorize(self::MODEL.'-delete');
    ...
    public function get(Request $request)
    {
        ...
        $active = $request->active;
           ...
           $alldata = TypeActivity::get();
        
            if($active=='All'){
                $alldata = TypeActivity::withTrashed()->get();
            }
            elseif($active=='Active'){
                $alldata = TypeActivity::get();
            }
            elseif($active=='DeActive'){
                $alldata = TypeActivity::onlyTrashed()->get();
            }
