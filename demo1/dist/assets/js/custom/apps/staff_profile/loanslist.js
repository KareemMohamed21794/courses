...
// Class definition
var KTDatatablesServerSideLoans = function () {
    // Shared variables
    var table;
    var dt;
    var filterPayment;
    ...
    let main_url = "/admin/staff_profile/getloans/"+staff_id;
    ...
    var initDatatable = function () {
        dt = $("#kt_datatable_table_loans").DataTable({
...
KTUtil.onDOMContentLoaded(function () {
    KTDatatablesServerSideLoans.init();
});