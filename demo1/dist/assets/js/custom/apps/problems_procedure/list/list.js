...
var KTDatatablesServerSide = function () {
    ...
    var problems_procedure_id = $("#problems_procedure_id").val();
    
    let main_url = "/admin/get_problems_procedure/"+problem_id+"?problems_procedure_id="+problems_procedure_id;
                        ...
                        return `
                            ...
                            <div   class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3" style="display:`+display_file+`">
                                    <a href="/admin/problems_procedure_files/`+row.id+`" class="menu-link px-3">
                                        ملف/ملفات
                                    </a>
                                </div>
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3" style="display:`+display_show+`">
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var type = "DELETE";
                        var ajaxurl = '/admin/delete_problems_procedure/'+rowID;
        ...
        deleteSelected.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    var type = "DELETE";
                    var ajaxurl = '/admin/delete_problems_procedure';
