...
var KTDatatablesServerSide = function () {
    ...
    let main_url = "/admin/type_activities/get";
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var type = "DELETE";
                        var ajaxurl = '/admin/type_activities/'+rowID;
        ...
        deleteSelected.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    var type = "DELETE";
                    var ajaxurl = '/admin/delete_type_activities';
...
function reject_accept(status,id) {
    ...
    var type = "GET";
    var ajaxurl = '/admin/type_activities/'+status+'/'+id+'/reject_accept';
