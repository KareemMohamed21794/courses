...
var KTDatatablesServerSide = function () {
    ...
    let main_url = "/admin/get_client_files/"+client_id;
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return `
                            <a style="display:`+display+`" href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
                                `+action_lang+`
                            ...
                            <!--begin::Menu-->
                            <div style="display:`+display+`"  class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3" style="display:`+display+`">
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var type = "DELETE";
                        var ajaxurl = '/admin/delete_client_files/'+rowID;
        ...
        deleteSelected.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    var type = "DELETE";
                    var ajaxurl = '/admin/delete_client_files';
