...
var KTDatatablesServerSide = function () {
    ...
    let main_url = "/admin/reports/get";
    ...
    var handleFilterDatatable = () => {
        ...
        filterButton.addEventListener('click', function () {
            ...
            var warehouse_location_id = $('#warehouse_location_id_filter').val();
            // Filter datatable --- official docs reference: https://datatables.net/reference/api/search()
            var url = main_url;
            url = url+"?product_id="+product_id+"&warehouse_location_id="+warehouse_location_id;
            dt.ajax.url(url);
            dt.draw();
        });
    }
