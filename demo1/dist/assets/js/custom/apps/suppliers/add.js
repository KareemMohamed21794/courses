				...
				validator.validate().then(function (status) {
					if (status === 'Valid') {
			        	...
			        	var formData = {
			            	...
			            	/*commercial_registration_no: jQuery('#commercial_registration_no').val(),
			            	tax_registration_no: jQuery('#tax_registration_no').val(),
			            	tax_file_no: jQuery('#tax_file_no').val(),
			            	tax_office: jQuery('#tax_office').val(),
								...
								setTimeout(function() {
									...
									Swal.fire({
										...
										if (result.isConfirmed) {
                                            ...
                                            var code = Math.floor(Math.random() * (new Date()).getTime()).toString(36);
                                            $('#code').val(code);
