...
var KTModalAddNotes = function () {
    ...
    return {
        ...
        init: function () {
            // Elements
            modal = new bootstrap.Modal(document.querySelector('#kt_modal_reject'));
            form = document.querySelector('#kt_modal_reject_form');
            submitButton = form.querySelector('#kt_modal_reject_submit');
            cancelButton = form.querySelector('#kt_modal_reject_cancel');
            closeButton = form.querySelector('#kt_modal_reject_close');
