...
var KTDatatablesServerSide = function () {
    ...
    let main_url = "/admin/get_problems_other_person_other_lawer/"+problem_id;
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var type = "DELETE";
                        var ajaxurl = '/admin/delete_problems_other_person_other_lawer/'+rowID;
        ...
        deleteSelected.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    var type = "DELETE";
                    var ajaxurl = '/admin/delete_problems_other_person_other_lawer';
