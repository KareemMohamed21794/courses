...
var KTModalAddNotes = function () {
    ...
    return {
        ...
        init: function () {
            // Elements
            modal = new bootstrap.Modal(document.querySelector('#kt_modal_add_finish_notes'));
            form = document.querySelector('#kt_modal_add_finish_notes_form');
            submitButton = form.querySelector('#kt_modal_add_finish_notes_submit');
            cancelButton = form.querySelector('#kt_modal_add_finish_notes_cancel');
            closeButton = form.querySelector('#kt_modal_add_finish_notes_close');
...
function update_finish_problem_id(id) {
    $("#finish_problem_id").val(id);
}