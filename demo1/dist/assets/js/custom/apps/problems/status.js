...
var KTModalStatus = function () {
    ...
    return {
        ...
        init: function () {
            // Elements
            modal = new bootstrap.Modal(document.querySelector('#kt_modal_status'));
            form = document.querySelector('#kt_modal_status_form');
            submitButton = form.querySelector('#kt_modal_status_submit');
            cancelButton = form.querySelector('#kt_modal_status_cancel');
            closeButton = form.querySelector('#kt_modal_status_close');
