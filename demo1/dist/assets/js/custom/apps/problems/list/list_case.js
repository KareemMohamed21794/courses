...
var KTDatatablesServerSide = function () {
    ...
    let main_url = "/"+guard+"/problems/get/"+type+"?client_id="+client_id+"&id="+id;
    ...
    var initDatatable = function () {
        dt = $("#kt_datatable_table").DataTable({
            ...
            columnDefs: [
                ...
                //         return `
                //             <div >
                //                 <input type="checkbox" data-toggle="switchbutton"   data-onstyle="danger">
                //             </div>`;
                //     }
                // },
                {
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                             ...
                             <!--begin::Menu item-->
                                ...
                                <div class="menu-item px-3" style="display:`+display_print+`">
                                    <a href="/admin/problems/case/print/`+row.id+`" class="menu-link px-3" target="_blank">
                                        استعراض   
                                    </a>
                                </div>
                                ...
                                <div class="menu-item px-3">
                                    <a href="/admin/problems_other_person_other_lawer/`+row.id+`" class="menu-link px-3">
                                        الاخصام
                                    </a>
                                </div>
                                <!--end::Menu item-->
