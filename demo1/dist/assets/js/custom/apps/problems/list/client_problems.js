...
var KTDatatablesServerSide = function () {
    ...
    let guard_type = $("#guard_type").val();

    var client_id = $("#client_id").val();
    var progress_from = $("#progress_from").val();
    var progress_to = $("#progress_to").val();
    var no_follow = $("#no_follow").val();
    var report_type = $("#report_type").val();

    let main_url = "/"+guard+"/client_problems_get?client_id="+client_id+"&progress_from="+progress_from+"&progress_to="+progress_to+"&no_follow="+no_follow+"&from="+from+"&to="+to+"&report_type="+report_type;
    var action_lang = $("#action_lang").val();
    var edit_lang = $("#edit_lang").val();
    var delete_lang = $("#delete_lang").val();
    var task_steps = $("#task_steps").val();
                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3" style="display:`+display_file+`">
                                    <a href="/admin/problems_files/`+row.id+`" class="menu-link px-3">
                                        ملف/ملفات
                                    </a>
                                </div>
                                ...
                                <div class="menu-item px-3" style="display:`+display_print+`">
                                    <a href="/admin/problems/procedure/print/`+row.id+`" class="menu-link px-3" target="_blank">
                                        استعراض 
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <div class="menu-item px-3" >
                                    <a href="/admin/problems_procedure/`+row.id+`" class="menu-link px-3">
                                        استعراض الاجراءات
                                    </a>
                                </div>
                                <!--end::Menu item-->
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var type = "DELETE";
                        var ajaxurl = '/admin/problems/'+rowID;
        ...
        deleteSelected.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    var type = "DELETE";
                    var ajaxurl = '/admin/delete_problems';
...
function finish_case(id) {
    ...
    var type = "GET";
    var ajaxurl = '/admin/finish_case/'+id;
