...
function getFieldData(id) {
    ...
    var type = "GET";
    var ajaxurl = '/admin/industries/'+id+'/get_fields';
...
function getActiveData(id) {
 ...
 var industry_id = $('#industry_id').val();
    ...
    var type = "GET";
    var ajaxurl = '/admin/activities/'+industry_id+'/'+id+'/get_activeties';
    ...
    $.ajax({
        ...
        success: function (data) {
        	...
        	$("[name='activity_id']").empty();
            var $dropdown = $("[name='activity_id']");
...
function getCity(id) {
    ...
    var type = "GET";
    var ajaxurl = '/admin/countries/'+id+'/get_cities';
