...
var KTDatatablesServerSide = function () {
    ...
    var problem_procedure_id = $("#problem_procedure_id").val();
    let main_url = "/admin/get_problem_procedure_files/"+problem_procedure_id;
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var type = "DELETE";
                        var ajaxurl = '/admin/delete_problem_procedure_files/'+rowID;
        ...
        deleteSelected.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    var type = "DELETE";
                    var ajaxurl = '/admin/delete_problem_procedure_files';
