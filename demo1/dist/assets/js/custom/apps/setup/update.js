            ...
            if (validator) {
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        axios.post("/admin/setup/"+update_id, new FormData(form))
...
function getData(id) {
    ...
    var type = "GET";
    var ajaxurl = '/admin/setup/'+id+'/edit';
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            jQuery('#commander_medal_date_update').val(data.commander_medal_date);
