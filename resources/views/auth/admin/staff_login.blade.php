                ...
                <div class="d-flex flex-column flex-lg-row-fluid py-10">
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid">
                        ...
                        <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                            ...
                            <form class=""  id="kt_sign_in_form" method="POST" action="{{ route('staff_login') }}"> 
                                ...
                                <div class="text-center mb-10">
                                    <!--begin::Title-->
                                    <h1 class="text-dark mb-3">Sign In As Staffs</h1>
                                    <!--end::Title-->
                                </div>
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <div class="d-flex flex-stack mb-2">
                                        <!--begin::Label-->
                                        <label class="form-label fw-bolder text-dark fs-6 mb-0">{{ __('Remember me') }}</label>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Wrapper-->
                                    <!--begin::Input-->
                    ...
                    <div class="d-flex flex-center flex-wrap fs-6 p-5 pb-0">
                        ...
                        <div class="d-flex flex-center fw-bold fs-6">
                            <a href="https://redgits.com" class="text-muted text-hover-primary px-2" target="_blank">About</a>
                            <a href="mailto:a.morsi@redgits.com" class="text-muted text-hover-primary px-2" target="_blank">Support</a>
                            <a href="tel:+201006379912" class="text-muted text-hover-primary px-2" target="_blank">Purchase</a>
                        </div>
                        <!--end::Links-->
                    </div>
                    <!--end::Footer-->
