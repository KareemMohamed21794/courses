                       ...
                       <!-- BEGIN MAIN Section  -->
                        <div id="accordion_update">
                            ...
                            <div class="card" id="card_update1">
                                ...
                                <div id="collapseOne_update" class="collapse" aria-labelledby="headingOne_update" data-parent="#accordion_update">
                                    <div class="card-body">
                                         <!--begin::group-->
                            ...
                            <div class="card" id="card_update2">
                                <div class="card-header" id="headingTwo_update">
                                    <h5 class="mb-0">
                                ...
                                <div id="collapseTwo_update" class="collapse" aria-labelledby="headingTwo_update" data-parent="#accordion_update">
                                    <div class="card-body">
                                        <!--begin::group-->
                            ...
                            <div class="card" id="card_update3">
                                <div class="card-header" id="headingThree_update">
                                    <h5 class="mb-0">
                                ...
                                <div id="collapseThree_update" class="collapse" aria-labelledby="headingThree_update" data-parent="#accordion_update">
                                    <div class="card-body">
                                        <!--begin::group-->
                            ...
                            <div class="card" id="card_update4">
                                <div class="card-header" id="headingFour_update">
                                    <h5 class="mb-0">
                                ...
                                <div id="collapseFour_update" class="collapse" aria-labelledby="headingFour_update" data-parent="#accordion_update">
                                    <div class="card-body">
                                         <!--begin::group-->
