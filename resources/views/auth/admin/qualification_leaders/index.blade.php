...
@section('content')
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <!--end::Card-->
            <!--begin::Modals-->
            @include('auth.admin.qualification_leaders.add')
            @include('auth.admin.qualification_leaders.update')
            <!--begin::Modal - Adjust Balance-->
            @include('auth.admin.qualification_leaders.export')
            <!--end::Modal - New Card-->
            <!--end::Modals-->
        </div>
        <!--end::Container-->
...
@section('scripts')
    ...
    <script src="{{ asset('demo1/dist/assets/js/custom/apps/qualification_leaders/list/export.js') }}"></script>
    <script src="{{ asset('demo1/dist/assets/js/custom/apps/qualification_leaders/list/list.js') }}"></script>
    <script src="{{ asset('demo1/dist/assets/js/custom/apps/qualification_leaders/add.js') }}"></script>
    <script src="{{ asset('demo1/dist/assets/js/custom/apps/qualification_leaders/update.js') }}"></script>
