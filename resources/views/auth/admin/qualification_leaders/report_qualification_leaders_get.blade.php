...
@section('content')
    ...
    <input type="hidden" name="current_qualification" id="current_qualification" value="{{ $current_qualification }}">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                           ...
                           <form class="w-px-500 p-3 p-md-3" action="{{ url('export_qualification_leaders') }}" method="get" enctype="multipart/form-data">
                            <input type="hidden" name="leader_id" id="leader_id" value="{{ $leader_id }}">
                            <input type="hidden" name="current_qualification" id="current_qualification" value="{{ $current_qualification }}">
...
@section('scripts')
    ...
    <!--begin::Page Custom Javascript(used by this page)-->
     ...
     <script src="{{ asset('demo1/dist/assets/js/custom/apps/qualification_leaders/report_qualification_leaders_get.js') }}"></script>
