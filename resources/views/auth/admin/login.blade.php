...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset('login_page_design/favicon.svg') }}">
  <link rel="stylesheet" href="{{ asset('login_page_design/style.css') }}">
</head>
    ...
    <div class="login-right-side">
      <div class="login-right-side-top-items">
        ...
        <div class="login-form">
          ...
          <form id="kt_sign_in_form" method="POST" action="{{ route('admin_login') }}">
            @csrf
            ...
            <div class="login-form-input">
              ...
              <input id="username" type="text" name="username" required autofocus value="{{ old('username') }}">
            </div>
            <div class="login-form-input">
