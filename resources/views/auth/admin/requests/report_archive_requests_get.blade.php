                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                            ...
                            <a href="{{ url('admin/report_archive_requests') }}" class="menu-link px-3">
...
@section('scripts')
    ...
    <!--begin::Page Custom Javascript(used by this page)-->
     ...
     <script src="{{ asset('demo1/dist/assets/js/custom/apps/requests/report_archive_requests_get.js') }}"></script>
