        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                ...
                @if($objAdmin->position_id == 2 )
                  ...
                  <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ 
                      Request::segment(2)=='leaders' ||
                      Request::segment(2)=='board_directors' || Request::segment(2)=='group_leaders'   ? 'show here' : '' }}">
               ...
               <!-- monitor advirtesmnt -->
                @if($objAdmin->position_id == 4 )
                 <div class="menu-item">
                    <a class="menu-link {{ Request::segment(2)=='your_advertisements' ? 'active' : '' }}" href="{{ url('admin/your_advertisements') }}">
                            ...
                            <span class="menu-title"> {{ __('messages.privite_advertisements') }}</span>
                            @if ($advirtesment_counter > 0)
                                <span class="circle-badge">{{ $advirtesment_counter }}</span>
                            @endif
               ...
               <!-- end monitor advirtesmnt -->
                ...
                @if($objAdmin->position_id == 1|| $objAdmin->position_id == 3 || $objAdmin->position_id == 4 || $objAdmin->position_id == 2)
                    ...
                    @if($objAdmin->position_id == 2)
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ Request::segment(2)=='show_students' ? 'active' : '' }}" href="{{ url('admin/show_students') }}/{{@$encodeId}}">
                                  <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon svg-icon-2">
      ...
      <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ 
          ...
          Request::segment(2)=='organizing_study' || Request::segment(2)=='study_report' || Request::segment(2)=='achievements_study_requirements'  ? 'show here' : '' }}">
                 ...
                 <span class="menu-link">
                            ...
                            @if ($total_leader_counter > 0)
                            <span class="circle-badge">{{ $total_leader_counter }}</span>
                            @endif
                            <span class="menu-arrow"></span>
                        </span>
                <div class="menu-sub menu-sub-accordion">
