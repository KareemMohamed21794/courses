    ...
    <div class="d-flex align-items-stretch flex-shrink-0">
        ...
        <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
            ...
            <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                <img src="{{ asset('public/images/profile.jpg') }}" alt="user" />
            </div>
            <!--begin::Menu-->
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                ...
                <div class="menu-item px-3">
                    <div class="menu-content d-flex align-items-center px-3">
                        ...
                        <div class="symbol symbol-50px me-5">
                            <img alt="Logo" src="{{ asset('public/images/profile.jpg') }}" />
                        </div>
                        <!--end::Avatar-->
                        <!--begin::Username-->
                        <div class="d-flex flex-column">
                            <div class="fw-bolder d-flex align-items-center fs-5">{{ __('messages.welcome') }} {{ $objAdmin->name }}
                            </div>
                        </div>
                        <!--end::Username-->
                    </div>
                ...
                <div style="display:none;" class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
                    @if(empty(session('admin_locale')) ||  session('admin_locale')=='en')
                    ...
                    @elseif(session('admin_locale')=='ar')
                    <a href="#" class="menu-link px-5">
                        <span class="menu-title position-relative">{{ __('messages.Language') }}
                        <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">{{ __('messages.Arabic') }}
                        <img class="w-15px h-15px rounded-1 ms-2" src="{{ asset('demo1/dist/assets/media/flags/egypt.svg') }}" alt="" /></span></span>
                    </a>
                    @endif
                    <!--begin::Menu sub-->
                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                        ...
                        <div class="menu-item px-3">
                            @if(Request::segment(1)=='admin')
                                <a href="{{ route('admin_language','en') }}" class="menu-link d-flex px-5 active">
                            @else
                                <a href="{{ route('client_language','en') }}" class="menu-link d-flex px-5 active">
                            @endif
                        ...
                        <div class="menu-item px-3">
                            @if(Request::segment(1)=='admin')
                                <a href="{{ route('admin_language','ar') }}" class="menu-link d-flex px-5 active">
                            @else
                                <a href="{{ route('client_language','ar') }}" class="menu-link d-flex px-5 active">
                            @endif
                            
                            <span class="symbol symbol-20px me-4">
                                <img class="rounded-1" src="{{ asset('demo1/dist/assets/media/flags/egypt.svg') }}" alt="" />
                ...
                <div style="display:none;" class="menu-item px-5 my-1">
                    <a href="{{ url('/client/profile') }}" class="menu-link px-5">{{ __('messages.Account Settings') }}</a>
                </div>
                <!--end::Menu item-->
                <!--begin::Menu item-->
                <div class="menu-item px-5">
                    ...
                    <form method="POST" action="{{ route('admin_logout') }}">
                        @csrf
                        <a class="menu-link px-5" href="{{ route('admin_logout') }}" onclick="event.preventDefault();this.closest('form').submit();">{{ __('messages.Sign Out') }}</a>
                    </form>
                    @else
                    <form method="POST" action="{{ route('client_logout') }}">
                        @csrf
                        <a class="menu-link px-5" href="{{ route('client_logout') }}" onclick="event.preventDefault();this.closest('form').submit();">{{ __('messages.Sign Out') }}</a>
                    </form>
                ...
                <div class="menu-item px-5" style="display: none;">
                    <div class="menu-content px-5">
                        <label class="form-check form-switch form-check-custom form-check-solid pulse pulse-success" for="kt_user_menu_dark_mode_toggle">
                            @if(Request::segment(1)=='admin')
                            <input class="form-check-input w-30px h-20px" type="checkbox" {{ session('darkmode') ? 'checked' : '' }} value="1" name="mode" id="kt_user_menu_dark_mode_toggle" data-kt-url="{{ route('admin_darkmode') }}" />
                            @elseif(Request::segment(1)=='client')
                            <input class="form-check-input w-30px h-20px" type="checkbox" {{ session('darkmode') ? 'checked' : '' }} value="1" name="mode" id="kt_user_menu_dark_mode_toggle" data-kt-url="{{ route('client_darkmode') }}" />
                            @endif
