...
@section('title', $title)
@section('content')
<input type="hidden" name="organizing_study_id" id="organizing_study_id" value="{{ $organizing_study_id }}">
    <!--begin::Post-->
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <!--end::Card-->
            <!--begin::Modals-->
            @include('auth.admin.organizing_study.files_add')
...
@section('scripts')
    ...
    <script src="{{ asset('demo1/dist/assets/js/custom/apps/organizing_study_files/list/export.js') }}"></script>
    <script src="{{ asset('demo1/dist/assets/js/custom/apps/organizing_study_files/list/list.js') }}"></script>
    <script src="{{ asset('demo1/dist/assets/js/custom/apps/organizing_study_files/add.js') }}"></script>
