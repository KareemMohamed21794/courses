...
@section('content')
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <!--end::Card-->
            <!--begin::Modals-->
            @include('auth.admin.type_activity.add')
            @include('auth.admin.type_activity.update')
            
            <!--begin::Modal - Adjust Balance-->
            @include('auth.admin.type_activity.export')
            <!--end::Modal - New Card-->
            <!--end::Modals-->
        </div>
        <!--end::Container-->
...
@section('scripts')
    ...
    <script src="{{ asset('demo1/dist/assets/js/custom/apps/type_activity/list/export.js') }}"></script>
    <script src="{{ asset('demo1/dist/assets/js/custom/apps/type_activity/list/list.js') }}"></script>
     
    <script src="{{ asset('demo1/dist/assets/js/custom/apps/type_activity/add.js') }}"></script>
    <script src="{{ asset('demo1/dist/assets/js/custom/apps/type_activity/update.js') }}"></script>
