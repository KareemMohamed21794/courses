    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">{{ __('messages.Export') }}</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <form id="kt_export_form" class="form" action="#">
                    ...
                    <div class="fv-row mb-10">
                        <!--begin::Label-->
                        <label class="fs-5 fw-bold form-label mb-5">{{ __('messages.Select Export Format') }}:</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                    ...
                    <div class="text-center">
                        <button type="reset" id="kt_export_cancel" class="btn btn-light me-3">{{ __('messages.Discard') }}</button>
                        <button type="submit" id="kt_export_submit" class="btn btn-primary">
                            <span class="indicator-label">{{ __('messages.Ok') }}</span>
