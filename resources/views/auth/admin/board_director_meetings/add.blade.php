...
<div class="modal fade" id="kt_modal_add" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="#" id="kt_modal_add_form" data-kt-redirect="{{ url('admin/board_director_meetings') }}"method="POST">
                @csrf
                <!--begin::Modal header-->
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    @endif
                        ...
                        <div class="fv-row mb-7">
                            <!--begin::Label-->
                            <label class="required fs-6 fw-bold mb-2">ارفاق ملف محضر اجتماع مجلس الإدارة</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="file" class="form-control form-control-solid" placeholder="ارفاق ملف محضر اجتماع مجلس الإدارة" name="board_director_meetings"  id="board_director_meetings"  />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
