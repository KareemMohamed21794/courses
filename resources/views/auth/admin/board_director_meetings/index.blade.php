                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--     <div id="export_buttons" style="margin-left: 10px;"></div> -->
                           <a href="{{url('admin/export_board_director_meetings')}}" class="menu-link px-3">
                        ...
                        <!--begin::Download Form-->
                         <a href="{{ url('public/') }}/{{@$objSetup->board_director_meeting_file}}" class="menu-link px-3" download="نموذج  اجتماعات الهيئه العامه">
                            <button type="button" class="btn btn-light-primary me-3" >
