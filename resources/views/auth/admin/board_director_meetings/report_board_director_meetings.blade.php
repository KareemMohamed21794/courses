...
<style type="text/css">
  ...
  .select2-container--open .select2-dropdown{
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_profile_details" class="collapse show">
                    <!--begin::Form-->
                     ...
                     <form id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="get" action="{{ url('admin/report_secondary_registrations_get') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                <!--begin::Label-->
                                <label class="col-lg-4 col-form-label fw-bold fs-6">اختر  السنه  </label>
                                <!--end::Label-->
                                <!--begin::Col-->
        ...
        <input type="hidden" name="type" id="type" value="board_director_meetings">
