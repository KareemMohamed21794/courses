...
<div class="modal fade" id="kt_modal_add" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="#" id="kt_modal_add_form" data-kt-redirect="{{ url('admin/administrative_financial_reports') }}"method="POST">
                @csrf
                <!--begin::Modal header-->
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    @endif
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="file" class="form-control form-control-solid" placeholder="ارفاق ملف التقرير الإداري" name="administrative_financial1"  id="administrative_financial1"  />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        @else
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="file" class="form-control form-control-solid" placeholder="ارفاق ملف التقرير المالي" name="administrative_financial2"  id="administrative_financial2"  />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
