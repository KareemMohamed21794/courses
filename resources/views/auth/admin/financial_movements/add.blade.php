                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_header" data-kt-scroll-wrappers="#kt_modal_add_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select name="payment_method_id" id="payment_method_id" aria-label="{{ __('messages.Select') }} {{ __('messages.payment_method') }}"   data-placeholder="{{ __('messages.Select') }} {{ __('messages.payment_method') }}" data-dropdown-parent="#kt_modal_add" class="form-select form-select-solid fw-bolder">
                                 <option value="">{{ __('messages.Select') }}</option >
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-solid" placeholder="{{ __('messages.price') }}" name="price"  id="price"  />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-solid" placeholder="{{ __('messages.receipt_number') }}" name="receipt_number"  id="receipt_number"  />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
