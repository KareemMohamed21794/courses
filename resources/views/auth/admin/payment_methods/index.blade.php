...
@section('content')
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <!--end::Card-->
            <!--begin::Modals-->
            @include('auth.admin.payment_methods.add')
            @include('auth.admin.payment_methods.update')
            
            <!--begin::Modal - Adjust Balance-->
            @include('auth.admin.payment_methods.export')
            <!--end::Modal - New Card-->
            <!--end::Modals-->
        </div>
        <!--end::Container-->
...
@section('scripts')
    ...
    <script src="{{ asset('demo1/dist/assets/js/custom/apps/payment_methods/list/export.js') }}"></script>
    <script src="{{ asset('demo1/dist/assets/js/custom/apps/payment_methods/list/list.js') }}"></script>
     
    <script src="{{ asset('demo1/dist/assets/js/custom/apps/payment_methods/add.js') }}"></script>
    <script src="{{ asset('demo1/dist/assets/js/custom/apps/payment_methods/update.js') }}"></script>
