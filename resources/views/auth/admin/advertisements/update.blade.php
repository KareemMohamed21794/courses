                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_update_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_header" data-kt-scroll-wrappers="#kt_modal_update_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="file" class="form-control form-control-solid" placeholder="الملف" name="file"   />
                             <a  download id="href_file">
                            <img id="file_update"  alt="file" width="100" height="100" >
                           </a>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="اسم الملف" name="file_name"  id="file_name_update"  />
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <textarea name="description"  id="description_update" class="form-control form-control-solid" ></textarea>
