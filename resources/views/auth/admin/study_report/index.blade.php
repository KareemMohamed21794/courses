                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--     <div id="export_buttons" style="margin-left: 10px;"></div> -->
                           <a href="{{url('admin/export_organizing_study')}}" class="menu-link px-3">
                ...
                <div class="card-body pt-0 table-responsive">
                    ...
                    <table id="kt_datatable_table" class="table align-middle table-row-dashed fs-6 gy-5 ">
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th>{{ __('messages.study_place') }}</th>
                            
                            <th>{{ __('messages.practical_place') }}</th>
                            <th>{{ __('messages.proposed_time_study') }}</th>
                            <th>{{ __('messages.maximum_number_students') }}</th>
