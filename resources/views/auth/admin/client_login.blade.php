                    ...
                    <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
                        ...
                        <div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
                            ...
                            <a href="" class="py-9 mb-5">
                                <img alt="Logo" src="{{ asset('demo1/dist/assets/media/logos/logo-2.svg') }}" class="h-90px" />
                ...
                <div class="d-flex flex-column flex-lg-row-fluid py-10">
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid">
                        ...
                        <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                            ...
                            <form class=""  id="kt_sign_in_form" method="POST" action="{{ route('client_login') }}" style="text-align: right !important;"> 
                                ...
                                <div class="fv-row mb-10">
                                    <!--begin::Label-->
                                    <label class="form-label fs-6 fw-bolder text-dark">{{ __('messages.username') }}</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <x-input id="username" class="form-control form-control-lg form-control-solid" type="username" name="username" :value="old('username')" required autofocus />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                <div class="fv-row mb-10">
                                    <!--begin::Wrapper-->
                                    <label style="margin-bottom: 5px !important;" class="form-label fw-bolder text-dark fs-6 mb-0">كلمه السر</label>
                                    <!--end::Wrapper-->
                                    <!--begin::Input-->
                                ...
                                <div class="fv-row mb-10">
                                    <!--begin::Wrapper-->
                                    <label class="form-label fw-bolder text-dark fs-6 mb-0">تذكرني</label>
                                    <!--end::Wrapper-->
                                    <!--begin::Input-->
