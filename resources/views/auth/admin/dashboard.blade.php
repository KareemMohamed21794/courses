                    ...
                    <div class="row g-5 g-xl-8">
                        ...
                        <div class="col-xl-3">
                            ...
                            <a href="{{ url('admin/board_director_meetings') }}" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                                ...
                                <div class="card-body">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen032.svg-->
                                    <svg width="45" version="1.1" id="x31" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                        ...
                        <div class="col-xl-3">
                            ...
                            <a href="{{ url('admin/qualification_leaders') }}" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="fw-bold text-gray-400">{{ __('messages.qualification_leaders') }} / غير مؤهل</div>
                                </div>
                                <!--end::Body-->
                            </a>
                            <!--end::Statistics Widget 5-->
                        ...
                        <div class="col-xl-3">
                            ...
                            <a href="{{ url('admin/qualification_leaders') }}" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="fw-bold text-gray-400">{{ __('messages.qualification_leaders') }} / مساعد قائد وحدة   </div>
                                </div>
                                <!--end::Body-->
                            </a>
                            <!--end::Statistics Widget 5-->
                        ...
                        <div class="col-xl-3">
                            ...
                            <a href="{{ url('admin/qualification_leaders') }}" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="fw-bold text-gray-400">{{ __('messages.qualification_leaders') }} / قائد وحدة شارة خشبية   </div>
                                </div>
                                <!--end::Body-->
                            </a>
                            <!--end::Statistics Widget 5-->
                        ...
                        <div class="col-xl-3">
                            ...
                            <a href="{{ url('admin/qualification_leaders') }}" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="fw-bold text-gray-400">{{ __('messages.qualification_leaders') }} / مساعد قائد تدريب</div>
                                </div>
                                <!--end::Body-->
                            </a>
                            <!--end::Statistics Widget 5-->
                        ...
                        <div class="col-xl-3">
                            ...
                            <a href="{{ url('admin/qualification_leaders') }}" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="fw-bold text-gray-400">{{ __('messages.qualification_leaders') }} / قائد تدريب</div>
                                </div>
                                <!--end::Body-->
                            </a>
                            <!--end::Statistics Widget 5-->
