                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_header" data-kt-scroll-wrappers="#kt_modal_add_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-7" >
                            ...
                            <label class="fs-6 fw-bold mb-2">
                                <span class="required">{{ __('messages.students') }}</span>
                                 
                            </label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select required name="student_id[]" id="student_id" aria-label="{{ __('messages.Select') }} " data-control="select2" data-placeholder="{{ __('messages.Select') }} " data-dropdown-parent="#kt_modal_add" class="form-select form-select-solid fw-bolder" multiple>
                      ...
                      <input type="hidden" name="admin_id" id="admin_id" value="{{ $objAdmin->id }}">
