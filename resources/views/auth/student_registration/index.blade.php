                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                            ...
                            <!-- <div id="export_buttons" style="margin-left: 10px;"></div> -->
                             <form class="w-px-500 p-3 p-md-3" action="{{ url('admin/export_student_registration_all') }}" method="get" enctype="multipart/form-data">
                            <input type="hidden" name="leader_id" id="leader_id" value="{{ $id }}">
                        ...
                        <div class="d-flex justify-content-end align-items-center d-none" data-kt-docs-table-toolbar="selected">
                            ...
                            <div class="fw-bolder me-5" style="visibility: hidden;">
                            <span class="me-2"></span>{{ __('messages.Selected') }}</div>
                             <button type="button" class="btn btn-success me-2" data-kt-docs-table-select="approve_selected">{{ __('messages.Approve_Selected') }}</button>
                        </div>
                        <!--end::Group actions-->
                    </div>
                    <!--end::Card toolbar-->
                ...
                <div class="card-body pt-0 table-responsive">
                    ...
                    <table id="kt_datatable_table" class="table align-middle table-row-dashed fs-6 gy-5 ">
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th>الجنسية</th>
                            <th>الرقم الوطني</th>
                            <th>الحالة بين الأبوين</th>
                            <th>المؤهل العلمي</th>
                            <th>نوع الدم</th>
                            <th>الجنس</th>
                            <th>الهوايات</th>
                            <th>ما هي الأمراض مزمنة أو الظروف الصحية</th>
                            <th>المدينة</th>
                            <th>المنطقة</th>
                            <th>اسم الشارع</th>
                            <th>أقرب معلم</th>
                            ...
                            <th>مهنة ولي الأمر </th>
                            <th>صلة القرابة</th>
                            <th>مكان عمل ولي الأمر</th>
