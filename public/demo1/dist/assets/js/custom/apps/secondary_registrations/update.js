            ...
            if (validator) {
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        axios.post("/admin/secondary_registrations/"+update_id, new FormData(form))
    ...
    $.ajax({
        ...
        success: function (data) {
           ...
           var image_path =  '../images/files/'
            ...
            var secondary_registration = document.getElementById("secondary_registration_update");
            var href_secondary_registration = document.getElementById("href_secondary_registration");
           
           
            // Set the 'src' and  'href'  attribute of the image element using the JSON data
            secondary_registration.src = image_path+data.secondary_registration;
            href_secondary_registration.href = image_path+data.secondary_registration;
