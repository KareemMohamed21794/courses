...
function getData(id) {
    ...
    var type = "GET";
    var ajaxurl = '/admin/assign-permissions/'+id+'/edit';
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            jQuery('#name_update').val(data.display_name);
