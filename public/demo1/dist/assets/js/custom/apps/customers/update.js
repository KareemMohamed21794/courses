                ...
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        var formData = {
                            ...
                            national_id: jQuery('#national_id_update').val(),
                            passport_id: jQuery('#passport_id_update').val(),
                            email: jQuery('#email_update').val(),
                            select_active: jQuery('#select_active_update').val(),
                        };

                        var type = "PATCH";
                        var ajaxurl = '/client/customers/'+id;
...
function getData(id) {
    ...
    var type = "GET";
    var ajaxurl = '/client/customers/'+id+'/edit';
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            jQuery('#passport_id_update').val(data.passport_id);
