...
var KTDatatablesServerSide = function () {
    ...
    let main_url = "/admin/clients/get";
    ...
    var guard = $("#guard").val();
    var guard_type = $("#guard_type").val();
    
    var display_style = "";
    if(guard=='admin' && guard_type==0){
        display_style="none";
    }
    ...
    var initDatatable = function () {
        ...
        dt = $("#kt_datatable_table").DataTable({
            ...
            columns: [
                ...
                { data: 'type' },
                { data: 'name_ar' },
                { data: 'claims_and_procedures' },
                { data: 'cases' },
                { data: 'phone' },
                { data: 'street_name' },
                { data: 'email' },
                { data: 'commercial_registration_no' },
                { data: 'country' },
                { data: 'client_customer_type' },
                { data: 'created_at' },
                { data: null },
            ],
            buttons: [
                ...
                // },
                {
                    ...
                    exportOptions: {
                        columns: ':not(:last-child,:first-child)',
                        modifier: {
                            search: 'applied', // Include the filtered rows only
                            page: 'all',       // Include all rows on all pages
                            // selected: true,    // Include only the selected rows if you want
                            // rows: function (idx, data, node) {
                            //     // Add any extra data you want to export here
                            //     // 'data' contains the row data for each row being exported
                            //     // 'node' contains the corresponding row HTML element

                            //     return [
                            //         data['id'],           // Include 'id' column
                            //     ];
                            // }
                        }
                    }
                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3" style="display:`+display_print+`">
                                    <a href="/admin/client/print/`+row.id+`" class="menu-link px-3" target="_blank">
                                        طباعه ملف العميل
                                    </a>
                                </div>
                                ...
                                <div class="menu-item px-3" style="display:`+display_file+`">
                                    <a href="/admin/client_files/`+row.id+`" class="menu-link px-3">
                                        ملف/ملفات
                                    </a>
                                </div>

                                <div class="menu-item px-3" style="display:`+display_file+`">
                                    <a href="/admin/client_permissions/`+row.id+`" class="menu-link px-3">
                                        الموكلين الآخرين
                                    </a>
                                </div>
                                 ...
                                 <!--begin::Menu item-->
                                <div class="menu-item px-3" style="display:`+display_case+`">
                                    <a href="/admin/problems/case?client_id=`+row.id+`" class="menu-link px-3">
                                     قضايا  الموكل
                                    </a>
                                </div>
                                 ...
                                 <!--begin::Menu item-->
                                <div class="menu-item px-3" style="display:`+display_procedure+`">
                                    <a href="/admin/problems/procedure?client_id=`+row.id+`" class="menu-link px-3">
                                        اجراءات الموكل
                                    </a>
                                </div>
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var type = "DELETE";
                        var ajaxurl = '/admin/clients/'+rowID;
        ...
        deleteSelected.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    var type = "DELETE";
                    var ajaxurl = '/admin/delete_clients';
...
KTUtil.onDOMContentLoaded(function () {
    // Clear the search input value when the page is refreshed
