...
var KTDatatablesServerSide = function () {
    ...
    if(firstSegment == 'admin'){
        var main_url = "/admin/reports/client_case_get_list?client_id="+client_id+"&from_date="+from_date+"&to_date="+to_date+" ";
    }
    if(firstSegment == 'client'){
        var main_url = "/client/reports/client_case_get_list?client_id="+client_id+"&from_date="+from_date+"&to_date="+to_date+" ";
    }
