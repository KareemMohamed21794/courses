...
var KTDatatablesServerSide = function () {
    ...
    if(firstSegment == 'admin'){
        var main_url = "/admin/reports/client_procedure_get_list?client_id="+client_id+"&from_date="+from_date+"&to_date="+to_date+"&id="+id+" ";
    }
    if(firstSegment == 'client'){
        var main_url = "/client/reports/client_procedure_get_list?client_id="+client_id+"&from_date="+from_date+"&to_date="+to_date+"&id="+id+" ";
    }
