...
var KTDatatablesServerSide = function () {
    ...
    let main_url = "/admin/commander_medals/get";
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        var type = "DELETE";
                        var ajaxurl = '/admin/commander_medals/'+rowID;
        ...
        deleteSelected.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    var type = "DELETE";
                    var ajaxurl = '/admin/delete_commander_medals';
...
function reject_accept(status,id) {
    ...
    var type = "GET";
    var ajaxurl = '/admin/commander_medals/'+status+'/'+id+'/reject_accept';
